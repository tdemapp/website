					...
					<v-flex xs12 v-for="(question, i) in questions" :key="i">
						...
						>
							...
							>
								...
								<span class="headline font-weight-black text-uppercase" v-text="question.title" />
							</v-card-title>
			...
			questions: [
				{
					emoji: '❓',
					title: 'What is TDEM',
					body: 'TDEM (TweetDeck Extension Manager) is a browser extension designed to provide a simple and easy way to install and manage extensions to enhance Twitter\'s TweetDeck client.',
				},
				{
					emoji: '🏗',
					title: 'How does it work',
					body: 'TDEM is build using a fork of the TD.Extensions specification built by the DeckHack team. ❤️ HUGE thanks to them for their work on creating the specification.',
				},
				{
					emoji: '🤝',
					title: 'Are you affiliated with Twitter',
					body: '**NO**. TDEM is in no way allifiated with Twitter or TweetDeck in anyway. ',
				},
				{
					emoji: '️💎',
					title: 'Is TDEM Free',
