		...
		return {
			questions: [
				...
				},
				{
					...
					body:
						'TDEM is build using a fork of the TD.Extensions specification built by the DeckHack team. ❤️ HUGE thanks to them for their work on creating the specification.',
				},
				{
					emoji: '🤝',
