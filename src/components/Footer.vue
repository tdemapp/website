	...
	<footer class="mt-24 bg-gray-900 sm:mt-12">
		...
		>
			<nav class="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
				...
				<div class="px-5 py-2">
					<a href="#" class="text-base text-gray-400 hover:text-gray-300"> FAQ </a>
				</div>

				<div class="px-5 py-2">
					<a href="#" class="text-base text-gray-400 hover:text-gray-300"> Releases </a>
				</div>

				<div class="px-5 py-2">
					<a href="#" class="text-base text-gray-400 hover:text-gray-300"> Disclaimer </a>
				</div>
			</nav>
