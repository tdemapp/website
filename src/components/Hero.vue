<template>
	<div class="pt-8 overflow-hidden sm:pt-12 lg:relative lg:py-48">
		...
		>
			<div>
				<div>
					<svg class="h-11 w-auto text-primary-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 35 32">
				...
				<div class="mt-20">
					...
					<div class="mt-12 sm:max-w-lg sm:w-full sm:flex sm:flex-col sm:justify-center">
